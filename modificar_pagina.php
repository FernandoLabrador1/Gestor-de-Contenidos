...
<body style="background-color: #E7E7E7">
    ...
    <form method="post">
        ...
        <h3 class="mb-5">Modificar página</h3>
            <div class="row">
                
                <div class="col-12">
                    <label class="form-label" for="form3Example3">Título</label>
                    <input type="usuario" id="form3Example3" class="form-control form-control-lg mb-5" placeholder="" name="titulo" value="<?php echo $titulo; ?>" />
                    <label for="floatingTextarea" >Contenido</label>
                </div>

                <div class="form-floating my-3">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px" name="contenido"><?php echo $contenido; ?></textarea>
                    ...
                    <input class="btn btn-primary my-3" type="submit" value="Modificar">
    ...
    <?php
        ...
        try {
            ...
            if ($_POST) {
                ...
                $sql = "UPDATE paginas SET TITULO=:titulo, CONTENIDO=:contenido, USUARIO=:user WHERE ID = :id";    
                $resultado = $BBDD->prepare($sql);
                    
                $resultado->execute(array(":titulo"=>$titulo, ":contenido"=>$contenido, ":user"=>$user, ":id"=>$codigoPagina2));
